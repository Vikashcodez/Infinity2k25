...
import qr from '../assets/QR/techtactoe.jpeg'
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${API_BASE_URL}/api/register/TechTacToe`, form, {
            ...
            <div className="max-w-2xl mx-auto">
                <Card>
                    <CardHeader className="text-center bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-t-lg">
                        <CardTitle className="text-3xl font-bold"><p className='text-white'>Tech Tac Toe</p></CardTitle>
