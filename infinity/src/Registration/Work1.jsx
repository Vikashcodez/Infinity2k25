...
import qr from '../assets/QR/work.jpeg'
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${API_BASE_URL}/api/register/Work1`, form, {
            ...
            <div className="max-w-2xl mx-auto">
                <Card>
                    <CardHeader className="text-center bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-t-lg">
                        <CardTitle className="text-3xl font-bold"><p className='text-white'>Generative AI Workshop</p></CardTitle>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col items-center space-y-4 p-6 bg-gray-50 rounded-lg">
                                    <h3 className="text-lg font-semibold text-gray-700">Registration Fee: ₹600 per person</h3>
                                    <img 
                                        src={qr}
                                        alt="Payment QR Code"
