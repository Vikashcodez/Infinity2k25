...
const EventPage = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      capacity: 50,
      type: "Competition",
      description: "ROUND 1: Tic Tac Toe meets quiz! With very basic Questions. ✔\nROUND 2: Snake and Ladder ",
      rules: ["🔹Basic Python knowledge recommended","🔹Mark ❌ or ⭕ only when you answer the quiz question correctly!","🔹🐍🪜 infused with tech quizzes! Answer questions, roll the dice 🎲 🍀, climb ladders 🪜, but watch out for snakes 🐍!"],
      image: techtac,
    ...
    },
    {
      ...
      capacity: 50,
      type: "Competition",
      description: "Puzzle Bit is an exciting, fast-paced challenge that tests your logic, coding, and puzzle-solving skills. ",
      rules: ["🔹Team size: 2 members","In Round 1, teams will tackle a mix of emojis, tech riddles, programming trivia, and puzzles, racing against time to earn points.","🔹In Round 2, they will decode technical clues to solve the Ultimate Tech Crossword, where speed is key-the fastest teams to finish will claim victory!"],
      image: puzzle,
    ...
    },
    {
      ...
      capacity: 50,
      type: "Competition",
      description: "A notorious hacker has been found dead—right after uncovering a dark secret that someone wanted buried forever. Was it revenge? A cover-up? Or something far more sinister? ",
      rules: ["🔹Team size: 1-4 members", "🔹Time limit: 20 minutes","🔹As elite investigators, your mission is twofold: unravel the mystery and escape before time runs out.","🔹You have 20 minutes to examine clues, decode messages, and uncover the killer’s identity.","🔹4 suspects. 1 murderer. Can you crack the case before it's too late? Or will the truth remain hidden in the shadows? "],
      image: escape,
    ...
    },
    {
      ...
      type: "Competition",
      description: [
        "Decrypt hidden messages, crack codes, and prove your hacking skills!",
